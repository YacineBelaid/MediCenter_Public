...
export class ArtefactService {
  ...
  getVisite(id: number): Observable<{ListeVisites : Visites[]}> {
    return this.http.post<{ ListeVisites : any }>(this.Read_API +"/" + "getVisite", id)
      .pipe(
        tap(response => {
  ...
  createVisite(id: number): Observable<{Visites : Visites}> {
    return this.http.post<{ Visites : Visites }>(this.Write_API +"/" + "create", id)
      .pipe(
        tap(response => {
  ...
  createAntecedants(id: number): Observable<{ListeAntecedants :Antecedants[]}> {
    return this.http.post<{ ListeAntecedants : any }>(this.Write_API +"/" + "create", id)
      .pipe(
        tap(response => {
  ...
  getAntecedants(id: number): Observable<{Antecedants :Antecedants}> {
    return this.http.post<{ Antecedants : Antecedants }>(this.Read_API +"/" + "getAntecedants", id)
      .pipe(
        tap(response => {
